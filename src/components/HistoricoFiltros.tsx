      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl border-2 border-gray-100 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 outline-none focus:border-[#00AEEF] focus:bg-white transition appearance-none"
            style={{
